...
public:
  ...
  using GoHomeCallback = std::function<bool()>;
  using SetPausedCallback = std::function<bool(const bool& setPaused)>;
...
private:
  ...
  GoHomeCallback m_go_home_callback;
  SetPausedCallback m_set_paused_callback;
